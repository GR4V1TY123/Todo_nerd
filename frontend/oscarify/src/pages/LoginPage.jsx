...
function LoginPage() {
  ...
  const handleSocialLogin = () => {
    // Navigate to dashboard on social login
    navigate('/app')
  }
  ...
  return (
    <div className="login-page">
      <div className="login-card">
        ...
        <p className="login-subtitle">Sign up or log in to get started</p>
        ...
        <div className="social-buttons">
          <button className="social-btn" onClick={handleSocialLogin}>
            <svg className="social-btn-icon" viewBox="0 0 24 24">
          ...
          <button className="social-btn" onClick={handleSocialLogin}>
            <svg className="social-btn-icon" viewBox="0 0 24 24" fill="#000">
